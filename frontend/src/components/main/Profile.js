                                                                                ...
                                                                                <div className="d-flex align-items-center justify-content-between">
                                                                                    <div className="d-flex align-items-center">
                                                                                        <div className="user-img me-3">
                                                                                            {photoUrl && <img src={photoUrl} alt="userimg" className="avatar-60 rounded-circle img-fluid" />}
                                                                                            :
                                                                                            {!photoUrl && <img src="/images/default.jpg" alt="userimg" className="avatar-60 rounded-circle img-fluid" />}
                                                                                        </div>
                                                                                        <h6>Your Story</h6>
                                                                                    </div>
